...
// 1. Searching
let hasJavaScript = console.log(inputString.includes("JavaScript")); 
let codingPosition = console.log(inputString.indexOf("Coding"));
let startsWithWelcome = console.log(inputString.startsWith("Welcome"));
let endsWithToday = console.log(inputString.endsWith("today"));
